                ...
                <div className="md:col-span-5 flex flex-col justify-between border-t md:border-t-0 md:border-l border-charcoal/15 pt-8 md:pt-0 md:pl-8 relative">
                  ...
                  <div className="space-y-3 pt-6 border-t border-charcoal/10">
                    ...
                    <div className="flex flex-wrap gap-4 text-charcoal/70">
                      ...
                      <a href="https://github.com/Krrish-Raj" target="_blank" rel="noopener noreferrer" className="hover:text-amber-accent transition-colors" title="GitHub profile">
                      ...
                      <a href="https://linkedin.com/in/krrish-raj" target="_blank" rel="noopener noreferrer" className="hover:text-amber-accent transition-colors" title="LinkedIn profile">
                        <svg className="w-4.5 h-4.5 fill-current" viewBox="0 0 24 24">
